...
Route::get ('board/index','App\Http\Controllers\PersonController@index');
Route::get ('board/add','App\Http\Controllers\PersonController@add');
Route::post ('board/add','App\Http\Controllers\PersonController@create');
